...
public class SNMPv3_Demo {
    final static OID[] columnOids = new OID[] {
        new OID("1.3.6.1.2.1.1.3.0"),
            ...
            new OID("1.3.6.1.2.1.33.1.3.3.1.2.1"),
            new OID("1.3.6.1.2.1.33.1.3.3.1.2.2"),
            new OID("1.3.6.1.2.1.33.1.3.3.1.2.3"),
            new OID("1.3.6.1.2.1.33.1.3.3.1.3.1"),
            new OID("1.3.6.1.2.1.33.1.3.3.1.3.2"),
            new OID("1.3.6.1.2.1.33.1.3.3.1.3.3"),
            new OID("1.3.6.1.2.1.33.1.5.1.0"),
            new OID("1.3.6.1.2.1.33.1.5.3.1.2.1"),
            new OID("1.3.6.1.2.1.33.1.5.3.1.2.1"),
            new OID("1.3.6.1.2.1.33.1.5.3.1.2.1")
    };
